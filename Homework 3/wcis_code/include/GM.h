...
struct GM {
    ...
    void getWCutset(vector<int>& order, vector<set<int> >& clusters,
                    vector<int>& wcutset, int w);
    bool verifyWCutset(vector<int>& order,vector<int>& wcutset, int w);
